   ...
   e.fn.form = function(t, o) {
     ...
     return r.each(function() {
       ...
       t = {
         ...
         bindEvents: function() {
           s.keyboardShortcuts && l.on("keydown" + f, t.event.field.keydown), o.on("submit" + f, t.validate.form), l.on("blur" + f, t.event.field.blur), t.attachEvents(T, "submit"), t.attachEvents(S, "reset"), t.attachEvents(k, "clear"), l.each(function() {
         ...
         clear: function() {
           l.each(function() {
             var n = e(this),
               ...
               s = i.is(d.uiCheckbox),
               c = i.is(d.uiDropdown),
               l = o.hasClass(m.error);
             l && (t.verbose("Resetting error on field", o), o.removeClass(m.error), a.remove()), c ? (t.verbose("Resetting dropdown value", i, r), i.dropdown("clear")) : s ? i.checkbox("uncheck") : (t.verbose("Resetting field value", n, r), n.val(""))
           })
         },
         reset: function() {
           l.each(function() {
             var n = e(this),
               ...
               c = i.is(d.uiDropdown),
               l = o.hasClass(m.error);
             l && (t.verbose("Resetting error on field", o), o.removeClass(m.error), a.remove()), c ? (t.verbose("Resetting dropdown value", i, r), i.dropdown("restore defaults")) : s ? (t.verbose("Resetting checkbox value", i, r), i.checkbox(r === !0 ? "check" : "uncheck")) : (t.verbose("Resetting field value", n, r), n.val(r))
           })
         },
         ...
         event: {
           field: {
             keydown: function(n) {
               ...
               o == a.escape && (t.verbose("Escape key pressed blurring field"), i.blur()), !n.ctrlKey && o == a.enter && i.is(d.input) && i.not(d.checkbox).length > 0 && (T.addClass(m.pressed), P || (i.one("keyup" + f, t.event.field.keyup), t.submit(), t.debug("Enter pressed on input submitting form")), P = !0)
             },
             keyup: function() {
               P = !1, T.removeClass(m.pressed)
             },
             blur: function() {
               var n = e(this),
                 i = n.closest(w);
               ...
               if (r)
                 if (u)
                   if (r = r.replace("[]", ""), o[r] || (o[r] = []), c) {
                     if (!m) return t.debug("Omitted unchecked checkbox", a), !0;
                     o[r].push(s)
                   } else o[r].push(s);
               else if (l) m && (o[r] = s);
               else if (c) {
           ...
           values: function(n) {
             e.isEmptyObject(n) || (e.each(n, function(n, i) {
               var o, a = t.get.field(n),
                 ...
                 u = a.is(d.radio) && c,
                 m = a.length > 0;
               m && (s && c ? (t.verbose("Selecting multiple", i, a), r.checkbox("uncheck"), e.each(i, function(e, t) {
         ...
         validate: {
           ...
           rule: function(n, o) {
             var a, r, c = t.get.field(n.identifier),
               ...
               m = d.exec(l),
               f = !0;
             return m !== i && null !== m ? (a = "" + m[1], r = l.replace(m[0], ""), f = s.rules[r].call(E, u, a)) : f = s.rules[l].call(c, u), f
           }
         },
         setting: function(t, n) {
 ...
 function(e, t, n, i) {
   ...
   e.fn.accordion = function(n) {
     ...
     return a.each(function() {
       ...
       m = {
         initialize: function() {
           m.debug("Initializing", w), m.bind.events(), m.observeChanges(), m.instantiate()
         },
         instantiate: function() {
           S = m, w.data(y, m)
         },
         ...
         bind: {
           events: function() {
             m.debug("Binding delegated events"), w.on("click" + b, v.trigger, m.event.click)
           }
         },
         event: {
           click: function() {
         ...
         open: function(t) {
           var n = t !== i ? "number" == typeof t ? C.eq(t) : e(t).closest(v.title) : e(this).closest(v.title),
             ...
             r = o.hasClass(g.active),
             s = !r && !a;
           s && (m.debug("Opening accordion content", n), f.exclusive && m.closeOthers.call(n), n.addClass(g.active), o.addClass(g.animating), f.animateChildren && (e.fn.transition !== i && w.transition("is supported") ? o.children().transition({
             animation: "fade in",
             queue: !1,
             useFailSafe: !0,
             debug: f.debug,
             ...
             opacity: 1
           }, f.duration, m.resetOpacity)), o.stop(!0).slideDown(f.duration, f.easing, function() {
         ...
         close: function(t) {
           var n = t !== i ? "number" == typeof t ? C.eq(t) : e(t).closest(v.title) : e(this).closest(v.title),
             ...
             s = !r && a,
             c = r && a;
           !r && !s || c || (m.debug("Closing accordion content", o), n.removeClass(g.active), o.addClass(g.animating), f.animateChildren && (e.fn.transition !== i && w.transition("is supported") ? o.children().transition({
             animation: "fade out",
             queue: !1,
             useFailSafe: !0,
             debug: f.debug,
             ...
             opacity: 0
           }, f.duration, m.resetOpacity)), o.stop(!0).slideUp(f.duration, f.easing, function() {
   ...
   e.fn.checkbox = function(n) {
     ...
     return a.each(function() {
       ...
       m = {
         ...
         refresh: function() {
           x = e(k), w = e(k).find(v.label).first(), C = e(k).find(v.input)
         },
         observeChanges: function() {
         ...
         add: {
           events: function() {
             m.verbose("Attaching checkbox events"), x.on("click" + b, m.toggle).on("keydown" + b, v.input, m.event.keydown)
           }
         },
         remove: {
           checked: function() {
         ...
         check: function() {
           m.debug("Enabling checkbox", C), C.prop("checked", !0).trigger("change"), m.set.checked(), C.trigger("blur"), f.onChange.call(C.get()), f.onChecked.call(C.get())
         },
         uncheck: function() {
           m.debug("Disabling checkbox"), C.prop("checked", !1).trigger("change"), m.remove.checked(), C.trigger("blur"), f.onChange.call(C.get()), f.onUnchecked.call(C.get())
         },
         toggle: function(e) {
 ...
 function(e, t, n, i) {
   ...
   e.fn.dimmer = function(t) {
     ...
     return a.each(function() {
         ...
         set: {
           opacity: function(e) {
             var e = g.opacity || e,
               ...
               n = t.split(","),
               i = n && 4 == n.length;
             i ? (n[3] = e + ")", t = n.join(",")) : t = "rgba(0, 0, 0, " + e + ")", f.debug("Setting opacity to", e), d.css("background-color", t)
           },
           active: function() {
             d.addClass(h.active)
           },
       ...
       }, f.preinitialize(), l ? (S === i && f.initialize(), f.invoke(c)) : (S !== i && S.invoke("destroy"), f.initialize())
     }), o !== i ? o : this
   ...
   e.fn.dropdown = function(o) {
     ...
     return r.each(function() {
       var p, v, h, b, y = e.isPlainObject(o) ? e.extend(!0, {}, e.fn.dropdown.settings, o) : e.extend({}, e.fn.dropdown.settings),
         ...
         F = P.find(T.search),
         R = P.find(T.input),
         O = P.prev().find(T.text).length > 0 ? P.prev().find(T.text) : P.prev(),
         D = P.children(T.menu),
         z = D.find(T.item),
         q = !1,
         j = !1,
       ...
       b = {
         ...
         setup: {
           ...
           select: function() {
             ...
             b.debug("Dropdown initialized on a select", t), P.is("select") && (R = P), R.parent(T.dropdown).length > 0 ? (b.debug("UI dropdown already exists. Creating dropdown menu only"), P = R.closest(T.dropdown), D = P.children(T.menu), 0 === D.length && (D = e("<div />").addClass(x.menu).appendTo(P)), D.html(y.templates.menu(t))) : (b.debug("Creating entire dropdown from select"), P = e("<div />").attr("class", R.attr("class")).addClass(x.selection).addClass(x.dropdown).html(y.templates.dropdown(t)).insertBefore(R), R.removeAttr("class").prependTo(P)), b.refresh()
           },
           reference: function() {
             var e, t, n = r.index(P);
             b.debug("Dropdown behavior was called on select, replacing with closest dropdown"), P = P.parent(T.dropdown), b.refresh(), e = r.slice(0, n), t = r.slice(n + 1), r = e.add(P).add(t), f && (I = b, b.invoke(m))
           }
         },
         refresh: function() {
           b.verbose("Refreshing selector cache"), E = P.find(T.text), F = P.find(T.search), R = P.find(T.input), O = P.prev().find(T.text).length > 0 ? P.prev().find(T.text) : P.prev(), D = P.children(T.menu), z = D.find(T.item)
         },
         toggle: function() {
         ...
         event: {
           ...
           searchBlur: function(e) {
             var t = n.activeElement === this;
             j || t || (y.forceSelection ? b.forceSelection() : b.hide())
           },
           ...
           keydown: function(e) {
             ...
             if (b.is.visible()) {
               if (u == d.enter && f && (m && !y.allowCategorySelection ? (b.verbose("Pressed enter on unselectable category, opening sub menu"), u = d.rightArrow) : (b.verbose("Enter key pressed, choosing selected item"), b.event.item.click.call(o, e))), u == d.leftArrow && c && (b.verbose("Left key pressed, closing sub-menu"), b.animate.hide(!1, s), o.removeClass(x.selected), s.closest(T.item).addClass(x.selected), e.preventDefault()), u == d.rightArrow && m && (b.verbose("Right key pressed, opening sub-menu"), b.animate.show(!1, r), o.removeClass(x.selected), r.find(T.item).eq(0).addClass(x.selected), e.preventDefault()), u == d.upArrow) {
                 if (t = f && l ? o.prevAll(T.item + ":not(." + x.filtered + ")").eq(0) : z.eq(0), a.index(t) < 0) return void b.verbose("Up key pressed but reached top of current menu");
               ...
               if (u == d.downArrow) {
                 if (t = f && l ? t = o.nextAll(T.item + ":not(." + x.filtered + ")").eq(0) : z.eq(0), 0 === t.length) return void b.verbose("Down key pressed but reached bottom of current menu");
         ...
         set: {
           ...
           scrollPosition: function(e, t) {
             ...
             e = e || b.get.activeItem(), n = e && e.length > 0, t = t !== i ? t : !1, e && n && (D.hasClass(x.visible) || D.addClass(x.loading), l = D.height(), a = e.height(), c = D.scrollTop(), s = D.offset().top, r = e.offset().top, o = c - s + r, d = o + m > c + l, u = c > o - m, b.debug("Scrolling to active item", o), (u || d || t) && D.scrollTop(o).removeClass(x.loading))
           },
           text: function(e) {
       ...
       }, f ? (I === i && b.initialize(), b.invoke(m)) : (I !== i && I.invoke("destroy"), b.initialize())
     }), a !== i ? a : r
 ...
 function(e, t, n, i) {
   ...
   e.fn.modal = function(o) {
     ...
     return r.each(function() {
       var r, h, b, y, x, w, C, T, k, S = e.isPlainObject(o) ? e.extend(!0, {}, e.fn.modal.settings, o) : e.extend({}, e.fn.modal.settings),
         A = S.selector,
         P = S.className,
         E = S.namespace,
         F = S.error,
       ...
       k = {
         initialize: function() {
           k.verbose("Initializing dimmer", z), k.create.id(), k.create.dimmer(), k.refreshModals(), k.verbose("Attaching close events", q), k.bind.events(), k.observeChanges(), k.instantiate()
         },
         instantiate: function() {
           k.verbose("Storing instance of modal"), N = k, D.data(O, N)
         },
         create: {
           dimmer: function() {
             var t = {
             ...
             return e.fn.dimmer === i ? void k.error(F.dimmer) : (k.debug("Creating dimmer with settings", n), y = z.dimmer(n), S.detachable && (k.verbose("Modal is detachable, moving content into dimmer"), y.dimmer("add content", D)), void(x = y.dimmer("get dimmer")))
           },
           id: function() {
             C = (Math.random().toString(16) + "000000000").substr(2, 8), w = "." + C, k.verbose("Creating unique id for element", C)
           }
         },
         destroy: function() {
           k.verbose("Destroying previous modal"), D.removeData(O).off(R), s.off(w), q.off(R), z.dimmer("destroy")
         },
         observeChanges: function() {
           "MutationObserver" in t && (T = new MutationObserver(function(e) {
         ...
         bind: {
           events: function() {
             q.on("click" + R, k.event.close), s.on("resize" + w, k.event.resize)
           }
         },
         get: {
           id: function() {
         ...
         event: {
           close: function() {
             k.verbose("Closing element pressed"), e(this).is(A.approve) ? S.onApprove.call(j) !== !1 ? k.hide() : k.verbose("Approve callback returned false cancelling hide") : e(this).is(A.deny) ? S.onDeny.call(j) !== !1 ? k.hide() : k.verbose("Deny callback returned false cancelling hide") : k.hide()
           },
           click: function(t) {
             0 === e(t.target).closest(D).length && (k.debug("Dimmer clicked, hiding all modals"), k.is.active() && (k.remove.clickaway(), S.allowMultiple ? k.hide() : k.hideAll()))
           },
           ...
           keyboard: function(e) {
             var t = e.which,
               n = 27;
             t == n && (S.closable ? (k.debug("Escape key pressed hiding modal"),
               k.hide()) : k.debug("Escape key pressed, but closable is set to false"), e.preventDefault())
           },
           resize: function() {
         ...
         showModal: function(t) {
           t = e.isFunction(t) ? t : function() {}, k.is.animating() || !k.is.active() ? (k.showDimmer(), k.cacheSizes(), k.set.position(), k.set.screenHeight(), k.set.type(), k.set.clickaway(), !S.allowMultiple && h.filter("." + P.active).length > 0 ? (k.debug("Other modals visible, queueing show animation"), k.hideOthers(k.showModal)) : (S.onShow.call(j), S.transition && e.fn.transition !== i && D.transition("is supported") ? (k.debug("Showing modal with css animations"), D.transition({
             debug: S.debug,
             ...
             useFailSafe: !0,
             onComplete: function() {
               S.onVisible.apply(j), k.add.keyboardShortcuts(), k.save.focus(), k.set.active(), k.set.autofocus(), t()
             }
           })) : (k.debug("Showing modal with javascript"), D.fadeIn(S.duration, S.easing, function() {
             S.onVisible.apply(j), k.add.keyboardShortcuts(), k.save.focus(), k.set.active(), t()
           })))) : k.debug("Modal is already visible")
         },
         hideModal: function(t, n) {
           t = e.isFunction(t) ? t : function() {}, k.debug("Hiding modal"), S.onHide.call(j), (k.is.animating() || k.is.active()) && (S.transition && e.fn.transition !== i && D.transition("is supported") ? (k.remove.active(), D.transition({
             debug: S.debug,
             ...
             useFailSafe: !0,
             onStart: function() {
               k.othersActive() || n || k.hideDimmer(), k.remove.keyboardShortcuts()
             },
             onComplete: function() {
               S.onHidden.call(j), k.restore.focus(), t()
             }
           })) : (k.remove.active(), k.othersActive() || k.hideDimmer(), k.remove.keyboardShortcuts(), D.fadeOut(S.duration, S.easing, function() {
             S.onHidden.call(j), k.restore.focus(), t()
           })))
         },
         showDimmer: function() {
         ...
         hideDimmer: function() {
           return y.dimmer("is animating") || y.dimmer("is active") ? void y.dimmer("hide", function() {
             S.transition && e.fn.transition !== i && D.transition("is supported") && (k.remove.clickaway(), k.remove.screenHeight())
         ...
         hideOthers: function(t) {
           ...
           t = e.isFunction(t) ? t : function() {}, n.length > 0 && (k.debug("Hiding other modals", h), n.modal("hide modal", t, !0))
         },
         ...
         set: {
           ...
           screenHeight: function() {
             k.can.fit() ? l.css("height", "") : (k.debug("Modal is taller than page content, resizing page height"), l.css("height", k.cache.height + S.padding / 2))
           },
           active: function() {
             D.addClass(P.active)
           },
           ...
           position: function() {
             k.verbose("Centering modal on page", k.cache), D.css(k.can.fit() ? {
               top: "",
       ...
       }, g ? (N === i && k.initialize(), k.invoke(f)) : (N !== i && N.invoke("destroy"), k.initialize())
     }), a !== i ? a : this
   }, e.fn.modal.settings = {
     name: "Modal",
     namespace: "modal",
 ...
 function(e, t, n, i) {
   ...
   e.fn.nag = function(n) {
     ...
     return a.each(function() {
       ...
       a = {
         initialize: function() {
           a.verbose("Initializing element"), b.data(h, a), y.on("click" + v, a.dismiss), m.detachable && b.parent()[0] !== x[0] && b.detach().prependTo(x), m.displayTime > 0 && setTimeout(a.hide, m.displayTime), a.show()
         },
         destroy: function() {
         ...
         storage: {
           ...
           get: function(n, o) {
             var r;
             return "localstorage" == m.storageMethod && t.localStorage !== i ? r = t.localStorage.getItem(n) : e.cookie !== i ? r = e.cookie(n) : a.error(g.noCookieStorage), ("undefined" == r || "null" == r || r === i || null === r) && (r = i), r
           },
           remove: function(n) {
   ...
   e.fn.popup = function(o) {
     ...
     return r.each(function() {
       ...
       h = {
         ...
         destroy: function() {
           h.debug("Destroying previous module"), n && !b.preserve && h.removePopup(), clearTimeout(h.hideTimer), clearTimeout(h.showTimer), F.off(p), A.off(k).removeData(S)
         },
         event: {
           start: function(t) {
         ...
         set: {
           position: function(o, a) {
             var s, c, l, u = (e(t).width(), e(t).height(), E.outerWidth()),
               ...
               v = b.distanceAway,
               y = E[0],
               T = b.inline ? parseInt(t.getComputedStyle(y).getPropertyValue("margin-top"), 10) : 0,
               k = b.inline ? parseInt(t.getComputedStyle(y).getPropertyValue(h.is.rtl() ? "margin-right" : "margin-left"), 10) : 0,
               S = b.inline || b.popup ? E.position() : E.offset();
             switch (o = o || A.data(C.position) || b.position, a = a || A.data(C.offset) || b.offset, O == b.maxSearchDepth && b.lastResort && (h.debug("Using last resort position to display", b.lastResort), o = b.lastResort), b.inline && (h.debug("Adding targets margin to calculation"), "left center" == o || "right center" == o ? (a += T, v += -k) : "top left" == o || "top center" == o || "top right" == o ? (a += k, v -= T) : (a += k, v += T)), h.debug("Calculating popup positioning", o), s = o, h.is.rtl() && (s = s.replace(/left|right/g, function(e) {
             ...
             if (c === i && h.error(w.invalidPosition, o), h.debug("Calculated popup positioning values", c), n.css(c).removeClass(x.position).addClass(o).addClass(x.loading), l = h.get.offstagePosition(o)) {
               ...
               if (!b.lastResort) return h.debug("Popup could not find a position in view", n), h.remove.attempts(), h.remove.loading(), h.reset(), !1
             }
         ...
         bind: {
           events: function() {
             h.debug("Binding popup events to module"), "click" == b.on ? A.on("click" + k, h.toggle) : h.get.startEvent() && A.on(h.get.startEvent() + k, h.event.start).on(h.get.endEvent() + k, h.event.end), b.target && h.debug("Target set to element", E), F.on("resize" + p, h.event.resize)
           },
           popup: function() {
             h.verbose("Allowing hover events on popup to prevent closing"), n && h.has.popup() && n.on("mouseenter" + k, h.event.start).on("mouseleave" + k, h.event.end)
           },
           close: function() {
       ...
       }, f ? (q === i && h.initialize(), h.invoke(m)) : (q !== i && q.invoke("destroy"), h.initialize())
     }), a !== i ? a : this
   }, e.fn.popup.settings = {
     name: "Popup",
     debug: !1,
       ...
       m = {
         ...
         get: {
           ...
           displayPercent: function() {
             ...
             return 0 === f.precision ? Math.round(i) : Math.round(10 * i * f.precision) / (10 * f.precision)
           },
           percent: function() {
             return m.percent || 0
           },
         ...
         set: {
           ...
           percent: function(e) {
             e = "string" == typeof e ? +e.replace("%", "") : e, e > 0 && 1 > e && (m.verbose("Module percentage passed as decimal, converting"), e = 100 * e), e = 0 === f.precision ? Math.round(e) : Math.round(10 * e * f.precision) / (10 * f.precision), m.percent = e, m.total ? m.value = Math.round(e / 100 * m.total * 10 * f.precision) / (10 * f.precision) : f.limitValues && (m.value = m.value > 100 ? 100 : m.value < 0 ? 0 : m.value),
               m.set.barWidth(e), m.is.visible() && m.set.labelInterval(), m.set.labels(), f.onChange.call(S, e, m.value, m.total)
           },
 ...
 function(e, t, n, i) {
   ...
   e.fn.search = function(o) {
     ...
     return e(this).each(function() {
       var f, g = e.extend(!0, {}, e.fn.search.settings, o),
         p = g.className,
         v = g.metadata,
         h = g.regExp,
         b = g.selector,
         ...
         A = T.find(b.results),
         P = (T.find(b.result), T.find(b.category), this),
         E = T.data(C);
       f = {
         initialize: function() {
           ...
           g.automatic && k.on(t + w, f.throttle).attr("autocomplete", "off"), k.on("focus" + w, f.event.focus).on("blur" + w, f.event.blur).on("keydown" + w, f.handleKeyboard), S.on("click" + w, f.query), A.on("mousedown" + w, f.event.result.mousedown).on("mouseup" + w, f.event.result.mouseup).on("click" + w, b.result, f.event.result.click), f.instantiate()
         },
         instantiate: function() {
           f.verbose("Storing instance of module", f), E = f, T.data(C, f)
         },
         destroy: function() {
           f.verbose("Destroying instance"), T.removeData(C), k.off(w), S.off(w), A.off(w)
         },
         event: {
           focus: function() {
             f.set.focus(), clearTimeout(f.timer), f.throttle(), f.has.minimumCharacters() && f.showResults()
           },
           blur: function(e) {
             var t = n.activeElement === this;
         ...
         handleKeyboard: function(e) {
           ...
           if (r == s.escape && (f.verbose("Escape key pressed, blurring search field"), k.trigger("blur")), f.is.visible())
             if (r == s.enter) {
           ...
           else r == s.enter && (f.verbose("Enter key pressed, executing query"), f.query(), f.set.buttonPressed(), k.one("keyup", f.remove.buttonFocus))
         },
         setup: {
           api: function() {
             var e = {
             ...
             f.verbose("First request, initializing API"), T.api(e)
           }
         },
         can: {
           useAPI: function() {
         ...
         get: {
           ...
           result: function(t, n) {
             var i = !1;
             return t = t || f.get.value(), n = n || f.get.results(), "category" === g.type ? (f.debug("Finding result that matches", t), e.each(n, function(n, o) {
               return e.isArray(o.results) && (i = f.search.object(t, o.results)[0], i && i.length > 0) ? !0 : void 0
             })) : (f.debug("Finding result in results object", t), i = f.search.object(t, n)[0]), i
           }
         },
         set: {
           focus: function() {
           ...
           value: function(e) {
             f.verbose("Setting search input value", e), k.val(e), f.query()
           },
         ...
         query: function() {
           var t = f.get.value(),
             n = f.read.cache(t);
           n ? (f.debug("Reading result for " + t + " from cache"), f.save.results(n.results), f.addResults(n.html)) : (f.debug("Querying for " + t), e.isPlainObject(g.source) || e.isArray(g.source) ? f.search.local(t) : f.can.useAPI() ? g.apiSettings ? (f.debug("Searching with specified API settings", g.apiSettings), f.search.remote(t)) : e.api.settings.api.search !== i ? (f.debug("Searching with default search API endpoint"), f.search.remote(t)) : f.error(y.noEndpoint) : f.error(y.source), g.onSearchQuery.call(P, t))
         },
         search: {
           local: function(e) {
             ...
             f.set.loading(), f.save.results(n), f.debug("Returned local search results", n), t = f.generateResults({
               results: n
             }), f.remove.loading(), f.write.cache(e, {
               html: t,
               results: n
             }), f.addResults(t)
           },
           remote: function(t) {
             ...
             T.api("get request") || f.setup.api(), e.extend(!0, n, g.apiSettings), f.debug("Executing search", n), f.cancel.query(), T.api("setting", n).api("query")
           },
           object: function(t, n) {
             var o = [],
               a = [],
             ...
             return n = n || g.source, n === i ? (f.error(y.source), []) : (e.each(r, function(i, r) {
               e.each(n, function(n, i) {
                 var s = "string" == typeof i[r],
                   l = -1 == e.inArray(i, o) && -1 == e.inArray(i, a);
                 s && l && (i[r].match(c) ? o.push(i) : g.searchFullText && f.fuzzySearch(t, i[r]) && a.push(i))
               })
             }), e.merge(o, a))
           }
         },
         ...
         parse: {
           response: function(e, t) {
             ...
             f.verbose("Parsing server response", e), e !== i && t !== i && e.results !== i && (f.write.cache(t, {
               html: n,
               results: e.results
             }), f.save.results(e.results), f.addResults(n))
           }
         },
         throttle: function() {
           clearTimeout(f.timer), f.has.minimumCharacters() ? f.timer = setTimeout(f.query, g.searchDelay) : f.hideResults()
         },
         cancel: {
           query: function() {
         ...
         save: {
           results: function(e) {
             f.verbose("Saving current search results to metadata", e), T.data(v.results, e)
           }
         },
         write: {
           cache: function(e, t) {
             var n = T.data(v.cache) !== i ? T.data(v.cache) : {};
             g.cache && (f.verbose("Writing generated html to cache", e, t), n[e] = t, T.data(v.cache, n))
           }
         },
         addResults: function(t) {
           return e.isFunction(g.onResultsAdd) && g.onResultsAdd.call(A, t) === !1 ? (f.debug("onResultsAdd callback cancelled default action"), !1) : (A.html(t), void f.showResults())
         },
         showResults: function() {
           f.is.visible() || !f.is.focused() || f.is.empty() || (f.can.transition() ? (f.debug("Showing results with css animations"), A.transition({
             animation: g.transition + " in",
             duration: g.duration,
             queue: !0
           })) : (f.debug("Showing results with javascript"), A.stop().fadeIn(g.duration, g.easing)), g.onResultsOpen.call(A))
         },
         hideResults: function() {
           f.is.visible() && (f.can.transition() ? (f.debug("Hiding results with css animations"), A.transition({
             animation: g.transition + " out",
             duration: g.duration,
             queue: !0
           })) : (f.debug("Hiding results with javascript"), A.stop().fadeOut(g.duration, g.easing)), g.onResultsClose.call(A))
         },
         generateResults: function(t) {
           ...
           var n = g.templates[g.type],
             ...
             a = "";
           return i || o ? (g.maxResults > 0 && (i ? "standard" == g.type && f.error(y.maxResults) : t.results = t.results.slice(0, g.maxResults)), e.isFunction(n) ? a = n(t) : f.error(y.noTemplate, !1)) : a = f.displayMessage(y.noResults, "empty"), g.onResults.call(P, t), a
         },
     ...
     return r.each(function() {
       ...
       g = {
         ...
         animate: function(e, n) {
           ...
           }, v.beforeChange.call(f.get()), g.get.transitionEvent() ? (g.verbose("Starting CSS animation"), T.addClass(x.animating), k.css(e).one(g.get.transitionEvent(), n), g.set.duration(v.duration), m(function() {
         ...
         set: {
           defaultSide: function() {
             t = T.find("." + v.className.active), f = t.next(b.side).length > 0 ? t.next(b.side) : T.find(b.side).first(), A = !1, g.verbose("Active side set to", t), g.verbose("Next side set to", f)
           },
           duration: function(e) {
           ...
           active: function() {
             g.verbose("Setting new side to active", f), S.removeClass(x.active), f.addClass(x.active), v.onChange.call(f.get()), g.set.defaultSide()
           }
         },
         flip: {
           up: function() {
   ...
   e.fn.sidebar = function(o) {
     ...
     return r.each(function() {
       var r, b, y, x, w, C, T = e.isPlainObject(o) ? e.extend(!0, {}, e.fn.sidebar.settings, o) : e.extend({}, e.fn.sidebar.settings),
         ...
         O = e(this),
         D = e(T.context),
         z = O.children(k.sidebar),
         q = D.children(k.fixed),
         j = D.children(k.pusher),
         N = this,
         I = O.data(R);
       C = {
         initialize: function() {
         ...
         bind: {
           clickaway: function() {
             C.verbose("Adding clickaway events to context", D), T.closable && D.on("click" + b, C.event.clickaway).on("touchend" + b, C.event.clickaway)
           },
           scrollLock: function() {
             T.scrollLock && (C.debug("Disabling page scroll"), s.on("DOMMouseScroll" + b, C.event.scroll)), C.verbose("Adding events to contain sidebar scroll"), c.on("touchmove" + b, C.event.touch), O.on("scroll" + F, C.event.containScroll)
           }
         },
         unbind: {
           clickaway: function() {
         ...
         refresh: function() {
           C.verbose("Refreshing selector cache"), D = e(T.context), z = D.children(k.sidebar), j = D.children(k.pusher), q = D.children(k.fixed)
         },
         refreshSidebars: function() {
           C.verbose("Refreshing other sidebars"), z = D.children(k.sidebar)
         },
         repaint: function() {
         ...
         setup: {
           layout: function() {
             0 === D.children(k.pusher).length && (C.debug("Adding wrapper element for sidebar"), C.error(E.pusher), j = e('<div class="pusher" />'), D.children().not(k.omitted).not(z).wrapAll(j), C.refresh()), (0 === O.nextAll(k.pusher).length || O.nextAll(k.pusher)[0] !== j[0]) && (C.debug("Moved sidebar to correct parent element"), C.error(E.movedSidebar, N), O.detach().prependTo(D), C.refresh()), C.set.pushable(), C.set.direction()
           }
         },
         attachEvents: function(t, n) {
           var i = e(t);
         ...
         show: function(t) {
           ...
           if (t = e.isFunction(t) ? t : function() {}, C.is.hidden()) {
             if (C.refreshSidebars(), T.overlay && (C.error(E.overlay), T.transition = "overlay"), C.refresh(), C.othersActive())
               if (C.debug("Other sidebars currently visible"), T.exclusive) {
                 if ("overlay" != T.transition) return void C.hideOthers(C.show);
                 C.hideOthers()
               } else T.transition = "overlay";
             n(function() {
               t.call(N), T.onShow.call(N)
             }), T.onChange.call(N), T.onVisible.call(N)
         ...
         legacyPushPage: function(t) {
           var n = O.width(),
             i = C.get.direction(),
             o = {};
           n = n || O.width(), t = e.isFunction(t) ? t : function() {}, o[i] = n, C.debug("Using javascript to push context", o), C.set.visible(), C.set.transition(), C.set.animating(), T.dimPage && j.addClass(S.dimmed), D.css("position", "relative").animate(o, T.duration, T.easing, function() {
         ...
         legacyPullPage: function(t) {
           var n = 0,
             i = C.get.direction(),
             o = {};
           n = n || O.width(), t = e.isFunction(t) ? t : function() {}, o[i] = "0px", C.debug("Using javascript to pull context", o), C.unbind.clickaway(), C.set.animating(), C.remove.visible(), T.dimPage && !C.othersActive() && j.removeClass(S.dimmed), D.css("position", "relative").animate(o, T.duration, T.easing, function() {
 ...
 function(e, t, n, i) {
   ...
   e.fn.sticky = function(n) {
     var o, a = e(this),
       ...
       d = [].slice.call(arguments, 1);
     return a.each(function() {
       var a, m, f, g = e.isPlainObject(n) ? e.extend(!0, {}, e.fn.sticky.settings, n) : e.extend({}, e.fn.sticky.settings),
         p = g.className,
         v = g.namespace,
         h = g.error,
         b = "." + v,
       ...
       f = {
         initialize: function() {
           f.determineContext(), f.verbose("Initializing sticky", g, C), f.save.positions(), f.checkErrors(), f.bind.events(), g.observeChanges && f.observeChanges(), f.instantiate()
         },
         instantiate: function() {
           f.verbose("Storing instance of module", f), k = f, x.data(y, f)
         },
         destroy: function() {
           f.verbose("Destroying previous instance"), f.reset(), m && m.disconnect(), w.off("load" + b, f.event.load).off("resize" + b, f.event.resize), T.off("scrollchange" + b, f.event.scrollchange), x.removeData(y)
         },
         observeChanges: function() {
           var e = a[0];
         ...
         determineContext: function() {
           return a = g.context ? e(g.context) : C, 0 === a.length ? void f.error(h.invalidContext, g.context, x) : void 0
         },
         checkErrors: function() {
           return f.is.hidden() && f.error(h.visible, x), f.cache.element.height > f.cache.context.height ? (f.reset(), void f.error(h.elementSize, x)) : void 0
         },
         bind: {
           events: function() {
             w.on("load" + b, f.event.load).on("resize" + b, f.event.resize), T.off("scroll" + b).on("scroll" + b, f.event.scroll).on("scrollchange" + b, f.event.scrollchange)
           }
         },
         event: {
           load: function() {
             f.verbose("Page contents finished loading"), S(f.refresh)
           },
           resize: function() {
             f.verbose("Window resized"), S(f.refresh)
           },
           scroll: function() {
             S(function() {
               T.trigger("scrollchange" + b, T.scrollTop())
             })
           },
           scrollchange: function(e, t) {
             f.stick(t), g.onScroll.call(A)
           }
         },
         refresh: function(e) {
         ...
         get: {
           ...
           elementScroll: function(e) {
             ...
             var t, n = f.cache.element,
               ...
               t = f.get.currentElementScroll(),
               r = t + o;
             return t = f.cache.fits || 0 > r ? 0 : r > a ? a : r
           }
         },
         remove: {
           offset: function() {
         ...
         set: {
           ...
           containerSize: function() {
             ...
             "HTML" === e || "body" == e ? C = x.offsetParent() : Math.abs(C.height() - f.cache.context.height) > 5 && (f.debug("Context has padding, specifying exact height for container", f.cache.context.height), C.css({
         ...
         stick: function(e) {
           var t = e || T.scrollTop(),
             ...
             a = n.window,
             r = n.context,
             s = f.is.bottom() && g.pushing ? g.bottomOffset : g.offset,
             e = {
               top: t + s,
               bottom: t + s + a.height
             },
             c = (f.get.direction(e.top), i ? 0 : f.get.elementScroll(e.top)),
             l = !i,
             u = 0 !== o.height;
           f.save.lastScroll(e.top), u && (f.is.initialPosition() ? e.top >= r.bottom ? (f.debug("Element bottom of container"), f.bindBottom()) : e.top >= o.top && (f.debug("Element passed, fixing element to page"), f.fixTop()) : f.is.fixed() ? f.is.top() ? e.top < o.top ? (f.debug("Fixed element reached top of container"), f.setInitialPosition()) : o.height + e.top - c > r.bottom ? (f.debug("Fixed element reached bottom of container"), f.bindBottom()) : l && f.set.scroll(c) : f.is.bottom() && (e.bottom - o.height < o.top ? (f.debug("Bottom fixed rail has reached top of container"), f.setInitialPosition()) : e.bottom > r.bottom ? (f.debug("Bottom fixed rail has reached bottom of container"), f.bindBottom()) : l && f.set.scroll(c)) : f.is.bottom() && (g.pushing ? f.is.bound() && e.bottom < r.bottom && (f.debug("Fixing bottom attached element to bottom of browser."), f.fixBottom()) : f.is.bound() && e.top < r.bottom - o.height && (f.debug("Fixing bottom attached element to top of browser."), f.fixTop())))
         },
         bindTop: function() {
           f.debug("Binding element to top of parent container"), f.remove.offset(), x.css("left", "").css("top", "").css("margin-bottom", "").removeClass(p.fixed).removeClass(p.bottom).addClass(p.bound).addClass(p.top), g.onTop.call(A), g.onUnstick.call(A)
         },
         bindBottom: function() {
           f.debug("Binding element to bottom of parent container"), f.remove.offset(), x.css("left", "").css("top", "").css("margin-bottom", f.cache.context.bottomPadding).removeClass(p.fixed).removeClass(p.top).addClass(p.bound).addClass(p.bottom), g.onBottom.call(A), g.onUnstick.call(A)
         },
         setInitialPosition: function() {
           f.unfix(), f.unbind()
         },
         fixTop: function() {
           f.debug("Fixing element to top of page"), f.set.offset(), x.css("left", f.cache.element.left).css("bottom", "").removeClass(p.bound).removeClass(p.bottom).addClass(p.fixed).addClass(p.top), g.onStick.call(A)
         },
         fixBottom: function() {
           f.debug("Sticking element to bottom of page"), f.set.offset(), x.css("left", f.cache.element.left).css("bottom", "").removeClass(p.bound).removeClass(p.top).addClass(p.fixed).addClass(p.bottom), g.onStick.call(A)
         },
         unbind: function() {
         ...
         reset: function() {
           f.debug("Reseting elements position"), f.unbind(), f.unfix(), f.resetCSS(), f.remove.offset()
         },
         resetCSS: function() {
           x.css({
             width: "",
 ...
 function(e, t, n, i) {
   ...
   e.fn.tab = function(n) {
     ...
     return r.each(function() {
       ...
       o = {
         initialize: function() {
           o.debug("Initializing tab menu item", k), o.determineTabs(), o.debug("Determining tabs", s.context, g), s.auto && o.set.auto(), e.isWindow(E) || (o.debug("Attaching tab activation events to element", k), k.on("click" + C, o.event.click)), o.instantiate()
         },
         ...
         get: {
           ...
           tabElement: function(e) {
             var t, n, i, a;
             return e = e || p, i = o.utilities.pathToArray(e), a = o.utilities.last(i), t = g.filter("[data-" + y.tab + '="' + a + '"]'),
               n = g.filter("[data-" + y.tab + '="' + e + '"]'), t.length > 0 ? t : n
           },
           tab: function() {
             return p
           }
       ...
       }, m ? (F === i && o.initialize(), o.invoke(d)) : (F !== i && F.invoke("destroy"), o.initialize())
   ...
   e.fn.transition = function() {
     ...
     return a.each(function(t) {
       ...
       T = {
         ...
         delay: function(e) {
           var n, o = f.reverse === !0,
             r = "auto" == f.reverse && T.get.direction() == v.outward;
           e = typeof e !== i ? e : f.interval, n = o || r ? (a.length - t) * f.interval : t * f.interval, T.debug("Delaying animation by", n), setTimeout(T.animate, n)
         },
         animate: function(e) {
           if (f = e || f, !T.is.supported()) return T.error(p.support), !1;
           ...
           T.can.animate() ? T.set.animating(f.animation) : T.error(p.noAnimation, f.animation, S)
         },
         reset: function() {
           T.debug("Resetting animation to beginning conditions"), T.remove.animationCallbacks(), T.restore.conditions(), T.remove.animating()
         },
         queue: function(e) {
           T.debug("Queueing animation of", e), T.queuing = !0, k.one(y + ".queue" + C, function() {
         ...
         set: {
           animating: function(e) {
             e = e || f.animation, T.is.animating() || T.save.conditions(), T.remove.direction(), T.remove.completeCallback(), T.can.transition() && !T.has.direction() && T.set.direction(), T.remove.hidden(), T.set.display(), k.addClass(v.animating + " " + v.transition + " " + e).addClass(e).one(y + ".complete" + C, T.complete), f.useFailSafe && T.add.failSafe(), T.set.duration(f.duration), f.onStart.call(this), T.debug("Starting tween", e, k.attr("class"))
           },
           duration: function(e, t) {
             t = t || f.duration, t = "number" == typeof t ? t + "ms" : t, (t || 0 === t) && (T.verbose("Setting animation duration", t), k.css({
           ...
           direction: function() {
             k.is(":visible") && !T.is.hidden() ? (T.debug("Automatically determining the direction of animation", "Outward"), k.removeClass(v.inward).addClass(v.outward)) : (T.debug("Automatically determining the direction of animation", "Inward"), k.removeClass(v.outward).addClass(v.inward))
           },
           looping: function() {
             T.debug("Transition set to loop"), k.addClass(v.looping)
           },
           hidden: function() {
             T.is.hidden() || k.addClass(v.transition).addClass(v.hidden), "none" !== k.css("display") && (T.verbose("Overriding default display to hide element"), k.css("display", "none"))
           },
           visible: function() {
             k.addClass(v.transition).addClass(v.visible)
           }
         },
         save: {
           ...
           conditions: function() {
             ...
             k.removeClass(f.animation), T.remove.direction(), T.cache = {
         ...
         restore: {
           conditions: function() {
             return T.cache === i ? !1 : (T.cache.className ? k.attr("class", T.cache.className) : k.removeAttr("class"), T.cache.style ? (T.verbose("Restoring original style attribute", T.cache.style), k.attr("style", T.cache.style)) : (T.verbose("Clearing style attribute"), k.removeAttr("style")), void T.verbose("Restoring original attributes", T.cache))
           }
         },
         add: {
           failSafe: function() {
             ...
             T.timer = setTimeout(function() {
               k.trigger(y)
             }, e + f.failSafeDelay), T.verbose("Adding fail safe timer", T.timer)
           }
         },
         remove: {
           animating: function() {
             k.removeClass(v.animating)
           },
           animation: function() {
             k.css({
               "-webkit-animation": "",
           ...
           direction: function() {
             k.removeClass(v.inward).removeClass(v.outward)
           },
           failSafe: function() {
             T.verbose("Removing fail safe timer", T.timer), T.timer && clearTimeout(T.timer)
           },
           hidden: function() {
             k.removeClass(v.hidden)
           },
           visible: function() {
             k.removeClass(v.visible)
           },
           looping: function() {
             T.debug("Transitions are no longer looping"), T.is.looping() && (T.reset(), k.removeClass(v.looping))
           },
           transition: function() {
             k.removeClass(v.visible).removeClass(v.hidden)
           }
         },
         get: {
           ...
           direction: function(t) {
             ...
             })), T.can.transition() ? k.is(":visible") && !T.is.hidden() ? v.outward : v.inward : "static"
           },
           duration: function(e) {
             return e = e || f.duration, e === !1 && (e = k.css("animation-duration") || 0), "string" == typeof e ? e.indexOf("ms") > -1 ? parseFloat(e) : 1e3 * parseFloat(e) : e
           },
           displayType: function() {
             return f.displayType ? f.displayType : (k.data(h.displayType) === i && T.can.transition(!0), k.data(h.displayType))
           },
           style: function() {
             var e = k.attr("style") || "";
         ...
         is: {
           animating: function() {
             return k.hasClass(v.animating)
           },
           inward: function() {
             return k.hasClass(v.inward)
           },
           outward: function() {
             return k.hasClass(v.outward)
           },
           looping: function() {
             return k.hasClass(v.looping)
           },
           occurring: function(e) {
             return e = e || f.animation, e = "." + e.replace(" ", "."), k.filter(e).length > 0
           },
           visible: function() {
             return k.is(":visible")
           },
         ...
         show: function(e) {
           T.verbose("Showing element", e), T.remove.hidden(), T.set.visible(), T.set.display(), T.repaint()
         },
         toggle: function() {
           T.is.visible() ? T.hide() : T.show()
         },
         stop: function() {
           T.debug("Stopping current animation"), k.trigger(y)
         },
         stopAll: function() {
           T.debug("Stopping all animation"), T.remove.queueCallback(), k.trigger(y)
         },
         clear: {
           queue: function() {
         ...
         enable: function() {
           T.verbose("Starting animation"), k.removeClass(v.disabled)
         },
         disable: function() {
           T.debug("Stopping animation"), k.addClass(v.disabled)
         },
         setting: function(t, n) {
           if (T.debug("Changing setting", t, n), e.isPlainObject(t)) e.extend(!0, f, t);
           else {
             if (n === i) return f[t];
             f[t] = n
           }
   ...
   e.api = e.fn.api = function(n) {
     ...
     return a.each(function() {
       var t, a, m, f, g, p = e.isPlainObject(n) ? e.extend(!0, {}, e.fn.api.settings, n) : e.extend({}, e.fn.api.settings),
         ...
         T = e(this),
         k = T.closest(b.form),
         S = p.stateContext ? e(p.stateContext) : T,
         A = this,
         P = S.get(),
         E = T.data(C);
       g = {
         ...
         query: function() {
           ...
           if (g.cancelled = !1, p.url ? (g.debug("Using specified url", m), m = g.add.urlData(p.url)) : (m = g.add.urlData(g.get.templateURL()), g.debug("Added URL Data to url", m)), !m) {
             if (!g.is.form()) return void g.error(y.missingURL, p.action);
             m = T.attr("action") || "", g.debug("No url or action specified, defaulting to form action", m)
           }
           g.set.loading(), t = e.extend(!0, {}, p, {
             ...
             failure: function() {},
             complete: function() {}
           }), g.debug("Querying URL", t.url), g.debug("Sending data", f, t.method), g.verbose("Using AJAX settings", t), g.is.loading() ? g.timer = setTimeout(function() {
           ...
           urlData: function(t, n) {
             ...
             return t && (o = t.match(p.regExp.required), a = t.match(p.regExp.optional), n = n || p.urlData, o && (g.debug("Looking for required URL variables", o), e.each(o, function(o, a) {
               var r = -1 !== a.indexOf("$") ? a.substr(2, a.length - 3) : a.substr(1, a.length - 2),
                 s = e.isPlainObject(n) && n[r] !== i ? n[r] : T.data(r) !== i ? T.data(r) : S.data(r) !== i ? S.data(r) : n[r];
             ...
             error: function(n, o, a) {
               ...
               if (n !== i)
                 if (n.readyState !== i && 4 == n.readyState) {
                   ...
                   g.remove.loading(), g.set.error(), p.errorDuration && setTimeout(g.remove.error, p.errorDuration), g.debug("API Request error:", s), p.onError.call(P, s, T)
                 } else p.onAbort.call(P, s, T), g.debug("Request Aborted (Most likely caused by page change or CORS Policy)", o, a)
             }
           }
         },
         create: {
         ...
         get: {
           ...
           defaultData: function() {
             var t = {};
             return e.isWindow(A) || (g.is.input() ? t.value = T.val() : g.is.form() && (t.text = T.text())), t
           },
           event: function() {
           ...
           formData: function() {
             var e;
             return T.serializeObject !== i ? e = k.serializeObject() : (g.error(y.missingSerialize), e = k.serialize()), g.debug("Retrieved form data", e), e
           },
           templateURL: function(e) {
             var t;
             return e = e || T.data(h.action) || p.action || !1, e && (g.debug("Looking up url for action", e, p.api), p.api[e] !== i ? (t = p.api[e], g.debug("Found template url", t)) : g.is.form() || g.error(y.missingAction, p.action, p.api)), t
           }
         },
         abort: function() {
           var e = g.get.xhr();
 ...
 function(e, t, n, i) {
   ...
   e.fn.state = function(t) {
     ...
     return a.each(function() {
       ...
       }, u ? (T === i && n.initialize(), n.invoke(l)) : (T !== i && T.invoke("destroy"), n.initialize())
     }), o !== i ? o : this
   }, e.fn.state.settings = {
     name: "State",
     debug: !1,
 ...
 function(e, t, n, i) {
   ...
   e.fn.visibility = function(o) {
     var a, r = e(this),
       ...
       m = [].slice.call(arguments, 1);
     return r.each(function() {
       var r, f, g = e.isPlainObject(o) ? e.extend(!0, {}, e.fn.visibility.settings, o) : e.extend({}, e.fn.visibility.settings),
         p = g.className,
         v = g.namespace,
         h = g.error,
         b = "." + v,
         ...
         k = t.requestAnimationFrame || t.mozRequestAnimationFrame || t.webkitRequestAnimationFrame || t.msRequestAnimationFrame || function(e) {
           setTimeout(e, 0)
         },
         S = this;
       f = {
         initialize: function() {
           f.debug("Initializing", g), f.setup.cache(), f.save.position(), f.should.trackChanges() && (f.bind.events(), "image" == g.type && f.setup.image(), "fixed" == g.type && f.setup.fixed(), g.observeChanges && f.observeChanges(), f.is.visible() || f.error(h.visible, w)), g.initialCheck && f.checkVisibility(), f.instantiate()
         },
         instantiate: function() {
           f.debug("Storing instance", f), w.data(y, f), T = f
         },
         destroy: function() {
           f.verbose("Destroying previous module"), r && r.disconnect(), x.off("load" + b, f.event.load).off("resize" + b, f.event.resize), C.off("scrollchange" + b, f.event.scrollchange), w.off(b).removeData(y)
         },
         observeChanges: function() {
           C[0];
           "MutationObserver" in t && (r = new MutationObserver(function(e) {
             f.verbose("DOM tree modified, updating visibility calculations"), f.timer = setTimeout(function() {
               f.verbose("DOM tree modified, updating sticky menu"), f.refresh()
             }, 100)
           }), r.observe(S, {
             childList: !0,
         ...
         bind: {
           events: function() {
             f.verbose("Binding visibility events to scroll and resize"), x.on("load" + b, f.event.load).on("resize" + b, f.event.resize), C.off("scroll" + b).on("scroll" + b, f.event.scroll).on("scrollchange" + b, f.event.scrollchange)
           },
           imageLoad: function() {
             var t = w.find("img"),
               i = t.length,
               ...
               l = function() {
                 a++, a >= i && (f.debug("Images finished loading inside element, refreshing position"), f.refresh())
               };
             if (i > 0)
               for (t.each(function() {
                   r.push(e(this).attr("src"))
                 }); o--;) c = n.createElement("img"), c.onload = l, c.onerror = l, c.src = r[o], s.push(c)
           }
         },
         event: {
           resize: function() {
             f.debug("Window resized"), k(f.refresh)
           },
           load: function() {
             f.debug("Page finished loading"), k(f.refresh)
           },
           scroll: function() {
             g.throttle ? (clearTimeout(f.timer), f.timer = setTimeout(function() {
               C.trigger("scrollchange" + b, [C.scrollTop()])
         ...
         should: {
           trackChanges: function() {
             return d ? (f.debug("One time query, no need to bind events"), !1) : (f.debug("Callbacks being attached"), !0)
           }
         },
         setup: {
           cache: function() {
           ...
           image: function() {
             var e = w.data("src");
             e && (f.verbose("Lazy loading image", e), g.observeChanges = !1, f.topVisible(function() {
               f.debug("Image top visible", S), f.precache(e, function() {
                 f.set.image(e), g.onTopVisible = !1
               })
             }))
           },
           fixed: function() {
             f.verbose("Setting up fixed on element pass"), g.once = !1, g.onTopPassed = function() {
         ...
         set: {
           image: function(t) {
             var n = f.cache.screen.bottom < f.cache.element.top;
             w.attr("src", t), n ? (f.verbose("Image outside browser, no show animation"), w.show()) : g.transition ? e.fn.transition !== i ? w.transition(g.transition, g.duration) : w.fadeIn(g.duration) : w.show()
           }
         },
         is: {
           visible: function() {
             return f.cache && f.cache.element ? f.cache.element.width > 0 : !1
           }
         },
         refresh: function() {
           f.debug("Refreshing constants (width/height)"), f.reset(), f.save.position(), f.checkVisibility(), g.onRefresh.call(S)
         },
         reset: function() {
           f.verbose("Reseting all cached values"), e.isPlainObject(f.cache) && (f.cache.screen = {}, f.cache.element = {})
         },
         checkVisibility: function(e) {
           f.verbose("Checking visibility of element", f.cache.element), f.is.visible() && (f.save.scroll(e), f.save.calculations(), f.passed(), f.passingReverse(), f.topVisibleReverse(), f.bottomVisibleReverse(), f.topPassedReverse(), f.bottomPassedReverse(), f.passing(), f.topVisible(), f.bottomVisible(), f.topPassed(), f.bottomPassed(), g.onUpdate && g.onUpdate.call(S, f.get.elementCalculations()))
         },
         passed: function(t, n) {
           var o = f.get.elementCalculations();
           if (t !== i && n !== i) g.onPassed[t] = n;
           else {
             if (t !== i) return f.get.pixelsPassed(t) > o.pixelsPassed;
             o.passing && e.each(g.onPassed, function(e, t) {
               o.bottomVisible || o.pixelsPassed > f.get.pixelsPassed(e) ? f.execute(t, e) : g.once || f.remove.occurred(t)
             })
           }
         },
         passing: function(e) {
           var t = f.get.elementCalculations(),
             n = e || g.onPassing,
             o = "passing";
           return e && (f.debug("Adding callback for passing", e), g.onPassing = e), t.passing ? f.execute(n, o) : g.once || f.remove.occurred(o), e !== i ? t.passing : void 0
         },
         topVisible: function(e) {
           var t = f.get.elementCalculations(),
             n = e || g.onTopVisible,
             o = "topVisible";
           return e && (f.debug("Adding callback for top visible", e), g.onTopVisible = e), t.topVisible ? f.execute(n, o) : g.once || f.remove.occurred(o), e === i ? t.topVisible : void 0
         },
         bottomVisible: function(e) {
           var t = f.get.elementCalculations(),
             n = e || g.onBottomVisible,
             o = "bottomVisible";
           return e && (f.debug("Adding callback for bottom visible", e), g.onBottomVisible = e), t.bottomVisible ? f.execute(n, o) : g.once || f.remove.occurred(o), e === i ? t.bottomVisible : void 0
         },
         topPassed: function(e) {
           var t = f.get.elementCalculations(),
             n = e || g.onTopPassed,
             o = "topPassed";
           return e && (f.debug("Adding callback for top passed", e), g.onTopPassed = e), t.topPassed ? f.execute(n, o) : g.once || f.remove.occurred(o), e === i ? t.topPassed : void 0
         },
         bottomPassed: function(e) {
           var t = f.get.elementCalculations(),
             n = e || g.onBottomPassed,
             o = "bottomPassed";
           return e && (f.debug("Adding callback for bottom passed", e), g.onBottomPassed = e), t.bottomPassed ? f.execute(n, o) : g.once || f.remove.occurred(o), e === i ? t.bottomPassed : void 0
         },
         passingReverse: function(e) {
           var t = f.get.elementCalculations(),
             n = e || g.onPassingReverse,
             o = "passingReverse";
           return e && (f.debug("Adding callback for passing reverse", e), g.onPassingReverse = e), t.passing ? g.once || f.remove.occurred(o) : f.get.occurred("passing") && f.execute(n, o), e !== i ? !t.passing : void 0
         },
         topVisibleReverse: function(e) {
           var t = f.get.elementCalculations(),
             n = e || g.onTopVisibleReverse,
             o = "topVisibleReverse";
           return e && (f.debug("Adding callback for top visible reverse", e), g.onTopVisibleReverse = e), t.topVisible ? g.once || f.remove.occurred(o) : f.get.occurred("topVisible") && f.execute(n, o), e === i ? !t.topVisible : void 0
         },
         bottomVisibleReverse: function(e) {
           var t = f.get.elementCalculations(),
             n = e || g.onBottomVisibleReverse,
             o = "bottomVisibleReverse";
           return e && (f.debug("Adding callback for bottom visible reverse", e), g.onBottomVisibleReverse = e), t.bottomVisible ? g.once || f.remove.occurred(o) : f.get.occurred("bottomVisible") && f.execute(n, o), e === i ? !t.bottomVisible : void 0
         },
         topPassedReverse: function(e) {
           var t = f.get.elementCalculations(),
             n = e || g.onTopPassedReverse,
             o = "topPassedReverse";
           return e && (f.debug("Adding callback for top passed reverse", e), g.onTopPassedReverse = e), t.topPassed ? g.once || f.remove.occurred(o) : f.get.occurred("topPassed") && f.execute(n, o), e === i ? !t.onTopPassed : void 0
         },
         bottomPassedReverse: function(e) {
           var t = f.get.elementCalculations(),
             n = e || g.onBottomPassedReverse,
             o = "bottomPassedReverse";
           return e && (f.debug("Adding callback for bottom passed reverse", e), g.onBottomPassedReverse = e), t.bottomPassed ? g.once || f.remove.occurred(o) : f.get.occurred("bottomPassed") && f.execute(n, o), e === i ? !t.bottomPassed : void 0
         },
         execute: function(e, t) {
           var n = f.get.elementCalculations(),
             i = f.get.screenCalculations();
           e = e || !1, e && (g.continuous ? (f.debug("Callback being called continuously", t, n), e.call(S, n, i)) : f.get.occurred(t) || (f.debug("Conditions met", t, n), e.call(S, n, i))), f.save.occurred(t)
         },
         remove: {
           occurred: function(e) {
             e ? f.cache.occurred[e] !== i && f.cache.occurred[e] === !0 && (f.debug("Callback can now be called again", e), f.cache.occurred[e] = !1) : f.cache.occurred = {}
           }
         },
         save: {
           calculations: function() {
             f.verbose("Saving all calculations necessary to determine positioning"), f.save.direction(), f.save.screenCalculations(), f.save.elementCalculations()
           },
           occurred: function(e) {
             e && (f.cache.occurred[e] === i || f.cache.occurred[e] !== !0) && (f.verbose("Saving callback occurred", e), f.cache.occurred[e] = !0)
           },
           scroll: function(e) {
             e = e + g.offset || C.scrollTop() + g.offset, f.cache.scroll = e
           },
           direction: function() {
             var e, t = f.get.scroll(),
               n = f.get.lastScroll();
             return e = t > n && n ? "down" : n > t && n ? "up" : "static", f.cache.direction = e, f.cache.direction
           },
           elementPosition: function() {
             var e = f.cache.element,
               t = f.get.screenSize();
             return f.verbose("Saving element position"), e.fits = e.height < t.height, e.offset = w.offset(), e.width = w.outerWidth(), e.height = w.outerHeight(), f.cache.element = e, e
           },
           elementCalculations: function() {
             var e = f.get.screenCalculations(),
               t = f.get.elementPosition();
             return g.includeMargin ? (t.margin = {}, t.margin.top = parseInt(w.css("margin-top"), 10), t.margin.bottom = parseInt(w.css("margin-bottom"), 10), t.top = t.offset.top - t.margin.top, t.bottom = t.offset.top + t.height + t.margin.bottom) : (t.top = t.offset.top, t.bottom = t.offset.top + t.height), t.topVisible = e.bottom >= t.top, t.topPassed = e.top >= t.top, t.bottomVisible = e.bottom >= t.bottom, t.bottomPassed = e.top >= t.bottom, t.pixelsPassed = 0, t.percentagePassed = 0, t.visible = t.topVisible || t.bottomVisible, t.passing = t.topPassed && !t.bottomPassed, t.hidden = !t.topVisible && !t.bottomVisible, t.passing && (t.pixelsPassed = e.top - t.top, t.percentagePassed = (e.top - t.top) / t.height), f.cache.element = t, f.verbose("Updated element calculations", t), t
           },
           screenCalculations: function() {
             var e = f.get.scroll();
             return f.save.direction(), f.cache.screen.top = e, f.cache.screen.bottom = e + f.cache.screen.height, f.cache.screen
           },
           screenSize: function() {
             f.verbose("Saving window position"), f.cache.screen = {
               height: C.height()
             }
           },
           position: function() {
             f.save.screenSize(), f.save.elementPosition()
           }
         },
         get: {
           ...
           occurred: function(e) {
             return f.cache.occurred !== i ? f.cache.occurred[e] || !1 : !1
           },
           direction: function() {
             return f.cache.direction === i && f.save.direction(), f.cache.direction
           },
           elementPosition: function() {
             return f.cache.element === i && f.save.elementPosition(), f.cache.element
           },
           elementCalculations: function() {
             return f.cache.element === i && f.save.elementCalculations(), f.cache.element
           },
           screenCalculations: function() {
             return f.cache.screen === i && f.save.screenCalculations(), f.cache.screen
           },
           screenSize: function() {
             return f.cache.screen === i && f.save.screenSize(), f.cache.screen
           },
           scroll: function() {
             return f.cache.scroll === i && f.save.scroll(), f.cache.scroll
           },
           lastScroll: function() {
             return f.cache.screen === i ? (f.debug("First scroll event, no last scroll could be found"), !1) : f.cache.screen.top
           }
         },
         setting: function(t, n) {
           if (e.isPlainObject(t)) e.extend(!0, g, t);
         ...
         invoke: function(t, n, o) {
           var r, s, c, l = T;
           return n = n || m, o = S || o, "string" == typeof t && l !== i && (t = t.split(/[\. ]/), r = t.length - 1, e.each(t, function(n, o) {
             var a = n != r ? o + t[n + 1].charAt(0).toUpperCase() + t[n + 1].slice(1) : t;
             if (e.isPlainObject(l[a]) && n != r) l = l[a];
             else {
               if (l[a] !== i) return s = l[a], !1;
       ...
       }, d ? (T === i && f.initialize(), f.invoke(u)) : (T !== i && T.invoke("destroy"), f.initialize())
     }), a !== i ? a : this
